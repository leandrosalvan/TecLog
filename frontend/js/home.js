// TecLog+ — Home: Relatório de Ganhos + registro de O.S.
...
function osLi(o, papel) {
  ...
  cliente.className = "os-cliente";
  cliente.textContent = o.cliente;
  main.appendChild(cliente);

  const meta = document.createElement("div");
  meta.className = "os-meta";
  meta.innerHTML =
    '<span class="os-classe">' + o.classe + "</span>" +
    '<span class="os-valor">' + brl(o.valor_repasse) + "</span>";
  main.appendChild(meta);

  const right = document.createElement("div");
  right.className = "os-right";

  const tecData = document.createElement("div");
  tecData.className = "os-tecdata";
  tecData.textContent =
    papel === "terceirizado"
      ? o.tecnico + " · " + dataBR(o.data_execucao)
      : dataBR(o.data_execucao);
  right.appendChild(tecData);
